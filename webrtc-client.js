...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Signaling server URL - configured by config.js
    // Fallback for standalone use (though config.js should always be loaded)
