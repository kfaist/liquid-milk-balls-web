# TouchDesigner WebRTC Setup - FINAL CORRECT VERSION
print("="*60)
print("TouchDesigner WebRTC/LiveKit Setup - FINAL CORRECT")
print("="*60)
...
# Configure Web Render TOP - USING CORRECT PARAMETER NAMES
web.par.url = 'http://localhost:3000/td-auto-viewer.html'
web.par.active = True
web.par.audio = 'on'  # Correct: 'on' not True
web.par.outputresolution = 'custom'  # Set to custom
web.par.resolutionw = 1920  # Correct parameter name
web.par.resolutionh = 1080  # Correct parameter name
web.nodeX = -200
web.nodeY = 200
