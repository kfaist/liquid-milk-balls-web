...
cmd = "op('/webrender1').par.reload.pulse(); print('WebRender reloaded!')"
pyperclip.copy(cmd)

# Find textport or open it
...
# Take screenshot
pyautogui.screenshot('C:/Users/krista-showputer/Desktop/liquid-milk-balls-web/final_check.png')
print('Done - check screenshot!')
