# TouchDesigner WebRTC Setup - FIXED ALL ISSUES
print("="*60)
print("TouchDesigner WebRTC/LiveKit Setup - FIXED")
print("="*60)
...
print(f"Resolution: {web.par.width.eval()} x {web.par.height.eval()}")
